...
useHead({ link: [{ rel: 'stylesheet', href: '/static/annotations/talebook-annotations.css?v=20260817-inline-edit' }] });
...
onMounted(async () => {
    ...
    const module = await import('/static/annotations/talebook-annotations.js?v=20260817-inline-edit');
